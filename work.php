...
<h1>ผลงานกองอาคารและสิ่งแวดล้อม</h1>
<hr>
...
<div class="row">
<img src=<?php echo $data['linka'] ?> alt="Bear" style="width:40%">
<img src=<?php echo $data['linkb'] ?> alt="Bear" style="width:40%">
<img src=<?php echo $data['linkc'] ?> alt="Bear" style="width:40%">
<img src=<?php echo $data['linkd'] ?> alt="Bear" style="width:40%">
 </div>
