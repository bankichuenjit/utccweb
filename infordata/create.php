...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($linka_err) && empty($name_err)){
        ...
        $sql = "INSERT INTO infor (linka, name) VALUES (?, ?)";
